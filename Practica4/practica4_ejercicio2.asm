...
CASO_DOS:
	...
	MOVLW 8         ; Carga el valor 8 en W (representa el número de bits en PORTB)
...
LOOP_CORRIMIENTO_CASO_DOS:
    ...
    RRF PORTB, 7    ; Corre el bit más significativo hacia la derecha en PORTB
...
LECTURA:
	...
	;------------CASO 2: Corrimiento del bit más significativo hacia la derecha	
    ...
    CALL CASO_TRES
	BCF STATUS, Z
	;------------CASO 4: Corrimiento del bit más significativo hacia la derecha y a la izquierda
